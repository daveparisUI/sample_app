...
describe User do
  ...
  #11.9: testing user.followed_users attribute
  it { should respond_to(:relationships) }
  it { should respond_to(:followed_users) }

  #11.15: testing reverse_relationships
  ...
  #11.3: testing User moved for user.relationship attribute
  it { should respond_to(:feed)}
  it { should respond_to(:relationships)}

  #11.11: utility methods for testing "Following"
  it { should respond_to(:followed_users)}
  #boolean method to determine if 1 user is following another
  it { should respond_to(:following?)}
  #testing writing, raising error if fails
  it { should respond_to(:follow!)}

  #11.13: testing for unfollowing user
  ...
  describe "following" do
    ...
    #11.15: cont'd - reverse relationship
